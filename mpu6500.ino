...
void mpuInit(){
	...
	// ADXL345初期化
	writeRegister(107,0b10000000);
	delay(200);
	writeRegister(104,0b00000111);
	delay(200);
	writeRegister(106,0b00010000);
	delay(200);
	writeRegister(27,0b00011000); 
	delay(200);
...
void updateMpuData(){
	...
	gyroT = (float)zg * (90.0 / 0xffff);	// 0xffff/2 * 180;
}
